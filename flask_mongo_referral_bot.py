...
MONGO_URI = first_valid_env("MONGODB_URI", "MONGO_URI", default="mongodb+srv://javohirtojiyev99_db_user:<javohir_2011>@cluster0.4skcgpy.mongodb.net/?appName=Cluster0")
